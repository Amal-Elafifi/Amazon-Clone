  ...
  return (
    <>
      <div className="py-20 grid place-items-center">
        ...
        <div className="max-w-[587px] max-h-[817px]  border rounded-xl py-[51px] px-[37px] space-y-4">
          <h2 className="text-3xl font-medium ">Create Account</h2>
          <form className="w-full text-left space-y-3" onSubmit={formik.handleSubmit}>
            <div>
            ...
            <p className="text-red-600 flex gap-1 items-center">
                <CircleAlert color="red" size={20} className=""/>{formik.errors.name}
            </p>
            ) : null}
            </div>
            <div>
            ...
            <p className="text-red-600 flex gap-1 items-center">
                <CircleAlert color="red" size={20} className=""/>{formik.errors.email}
            </p>
            ) : null}
            </div>
            <div>
            ...
            <p className="text-red-600 flex gap-1 items-center">
                <CircleAlert color="red" size={20} className=""/>{formik.errors.phone}
            </p>
            ) : null}
            </div>
            ...
            <p className="text-red-600 flex gap-1 items-center">
                <CircleAlert color="red" size={20} className=""/>{formik.errors.password}
            </p>
            ) : null}
            ...
            <p className="text-red-600 flex gap-1 items-center">
                <CircleAlert color="red" size={20} className=""/>{formik.errors.rePassword}
            </p>
            ) : null}
                <span onClick={toggleIcon} className="absolute top-[38px] right-3 cursor-pointer">{isEyeVisible?<Eye/>:<EyeOff/>}</span>
            </div>
          ...
          >
            <path
              d="M0.5 0.656738H488.5L243.933 4.65674L0.5 0.656738Z"
              fill="#D9D9D9"
            />
          </svg>
